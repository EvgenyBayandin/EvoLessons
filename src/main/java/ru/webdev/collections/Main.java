...
public class Main {
    ...
    Для решения проблемы в Java 5 принят способ параметризации типов <>. Это позволяет избежать проблемы при работе с динамическим массивом.
    В Java 7 это реализовано с помощью интерфейса Dynamic.
    */
